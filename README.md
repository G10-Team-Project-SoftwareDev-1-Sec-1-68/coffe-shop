...
## 👥 2.1 ทีมงาน และหน้าที่ความรับผิดชอบ

1. **ชิษณุพัศก์ วายุสุวรรณวิทย์ (68030063)** — *System Architect & Lead Backend Developer*
   - **หน้าที่รับผิดชอบ:** ออกแบบสถาปัตยกรรมระบบโดยรวม (System Architecture), ออกแบบฐานข้อมูล (Database Schema) ด้วย Prisma ORM, พัฒนา Core API หลังบ้านทั้งหมด (Auth, Orders, Inventory, POS Sync), จัดการระบบ Route Protection (Middleware) และเป็นผู้ขึ้นโครงสร้างโปรเจกต์หลัก

2. **จิตติพัฒน์ ลำดวน (68030039)** — *Front-end Developer*
   - **หน้าที่รับผิดชอบ:** รับผิดชอบการพัฒนาหน้าจอส่วนผู้ดูแลระบบ (Admin Dashboard) และประยุกต์ใช้เครื่องมือ AI ในจะช่วยขึ้นโครงสร้าง UI Component สำหรับหน้าแสดงผลผลลัพธ์การทำงาน

3. **นัทธพงศ์ เหมือนประสาน (68030135)** — *Backend Developer & API QA*
   - **หน้าที่รับผิดชอบ:** ตรวจสอบและทดสอบระบบหลังบ้าน (API Testing), ยิงทดสอบ Endpoint ทุกเส้นเพื่อตรวจสอบความถูกต้องของข้อมูล (Data Validation) และค้นหาพร้อมช่วยแก้ไขข้อผิดพลาด (Bug Fixing) ก่อนเชื่อมต่อกับหน้าบ้าน

4. **ณัชพล อ่อนบาง (68030084)** — *QA Tester & Front-end Developer*
   - **หน้าที่รับผิดชอบ:** จัดทำกรณีทดสอบ (Test Cases) เพื่อตรวจสอบการทำงานของระบบให้เป็นไปตาม Requirement และร่วมพัฒนาหน้าจอ User Interface ในส่วนของระบบการขายหน้าร้าน (POS Interface)

5. **ณัฏฐวรรณ ช่างเก็บ (68030085)** — *Lead UX/UI Designer*
   - **หน้าที่รับผิดชอบ:** ออกแบบ Wireframe และ Prototype หลักของระบบทั้งหมดผ่าน Figma, ควบคุมทิศทางการออกแบบ (Design System) และสร้างประสบการณ์การใช้งาน (UX) ภาพรวมของแอปพลิเคชัน

6. **ปทิตญา ภูกิจคุณาเดชากร (68030151)** — *Front-end Developer & Asset Manager*
   - **หน้าที่รับผิดชอบ:** พัฒนาหน้าจอแสดงผลในส่วนของเมนูสั่งสินค้า (Menu UI) สำหรับลูกค้า และรับผิดชอบการจัดหา รวบรวม ตลอดจนจัดการไฟล์รูปภาพสินค้าและ Asset ต่างๆ ที่ใช้ในโปรเจกต์

7. **ประภาภรณ์ ภูผาลี (68030159)** — *UX/UI Designer*
   - **หน้าที่รับผิดชอบ:** ร่วมออกแบบและปรับปรุงประสบการณ์ผู้ใช้งาน (UX/UI) โดยโฟกัสที่ส่วนของระบบหน้าจอการขายหน้าร้าน (POS System)
